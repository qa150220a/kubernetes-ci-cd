...
sudo docker build -t 127.0.0.1:30400/monitor-scale:$BUILD_TAG -f applications/monitor-scale/Dockerfile applications/monitor-scale
...
#Push the images
sudo docker push 127.0.0.1:30400/monitor-scale:$BUILD_TAG
